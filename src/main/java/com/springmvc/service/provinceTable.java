...
public Connection getConnection() {
    ...
    public boolean insert(User user){
        try {
            ...
            String sql = "insert into provinceTable(accompanyName,password,account,usingCondition,registerYear,registerMonth,registerDay,unregisterYear" +
    ...
    public void findById(int id, User user){
        try {
            Connection connection = getConnection();
            String sql = "select * from provinceTable where id=" + id;
            //System.out.println(sql);
            PreparedStatement ps = (PreparedStatement) connection.prepareStatement(sql);
            Statement stmt = (Statement) connection.createStatement();
            ResultSet rs = stmt.executeQuery(sql);
